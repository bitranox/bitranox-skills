...
- [ ] (2026-08-27) [10] USER: "review all skills and scripts one by one, each in its own subagent and ask when smth is to change" | size: 8 confirmed behavioural findings still unfixed, 5 untested-but-correct coverage gaps, about 7 reports named only in passing, 17 claims left unadjudicated inside the guard slice, and 88 of 135 targets never swept | open: the 7 gate/guard reports were adjudicated 2026-09-01 (5 under-blocks shipped in 5.299.0) and the 6 non-guard reports were adjudicated 2026-09-01 - 22 claims driven, 15 confirmed, 6 already fixed, 1 split - and the 2 session-start decoy-check findings shipped in 5.299.2 (48b616b), the scope the user chose | next: the 8 remaining confirmed findings - self-improve-audit test-fixture suppression and PreCompact wording, 3 in subagent-backstop-nudge, 1 in subagent-brief, the 3 stale Bash-only prose claims, and contrib_context which is item 65; detail in the NON-GUARD SLICE section of /media/srv-main-softdev/projects/public/KI/scriptwave-2026-08-28/TRIAGE.md
