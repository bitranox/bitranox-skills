...
- [ ] (2026-08-27) [10] USER: "review all skills and scripts one by one, each in its own subagent and ask when smth is to change" | size: 10 confirmed behavioural findings awaiting a fix decision, 5 untested-but-correct coverage gaps, about 7 reports named only in passing, 17 claims left unadjudicated inside the guard slice, and 88 of 135 targets never swept | open: the 7 gate/guard reports were adjudicated 2026-09-01 (5 under-blocks shipped in 5.299.0) and the 6 non-guard reports were adjudicated 2026-09-01 - 22 claims driven, 15 confirmed, 6 already fixed, 1 split - but NOTHING from the non-guard slice is fixed yet | next: put the 10 confirmed behavioural findings to the user in fixable groups; detail in the NON-GUARD SLICE section of /media/srv-main-softdev/projects/public/KI/scriptwave-2026-08-28/TRIAGE.md
