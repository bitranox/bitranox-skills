...
- [ ] (2026-08-27) [10] USER: "review all skills and scripts one by one, each in its own subagent and ask when smth is to change" | size: 88 of 135 targets remain, 4 slices | open: no decision recorded since 2026-08-28 | next: pick a slice from the TRIAGE.md in /tmp/scriptwave-2026-08-28, and copy that dir into the repo first because /tmp does not survive a reboot
