# skill-writer checklist - process-test-design: ship queued cross-project contributions (2026-07-30)
...
- [x] VERDICT: PASSED on BOTH tiers
- [x] Evidence, verbatim where quoted: sonnet and haiku both got the baseline-gate blindness and the import-binding mechanic; haiku even
      cited the relevant memory fact. Shipped on the maintainer's instruction. The index-is-used and
      semantic-codec-equivalence points were not probed by either scenario.
