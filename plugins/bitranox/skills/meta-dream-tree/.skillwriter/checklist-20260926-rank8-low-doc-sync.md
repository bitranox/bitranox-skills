# skill-writer checklist - meta-dream-tree (2026-09-26, doc sync for the 7.25.6 script fixes)

A clear scoped to one level adds to the record; a directory or fact deleted mid-run is passed over, not called unreadable.
...
- [x] Old passages (built from the porcelain word diff, not retyped), haiku, inert probe type:
      Q15 scoped clear and a copy at another level; a dir deleted mid-walk: NONE.
...
- [x] New passages, same model and questions:
      Q15 scoped clear and a copy at another level; a dir deleted mid-walk: "a copy at a level outside that scope keeps its verdict" / "is passed over rather than called unreadable".
