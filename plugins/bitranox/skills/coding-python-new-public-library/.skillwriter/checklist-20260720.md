...
- [x] Fixed: default-branch template-repo URL
      `github.com/bitranox/bitranox_template_py_lib/blob/master/docs/` (latest), and a note that a repo
      generated FROM the template carries these files locally (so `docs/...` resolves inside it).
