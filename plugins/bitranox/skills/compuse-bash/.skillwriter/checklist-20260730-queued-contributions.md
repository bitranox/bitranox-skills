# skill-writer checklist - compuse-bash: ship queued cross-project contributions (2026-07-30)
...
- [x] Evidence, verbatim where quoted: sonnet used `<<'PYEOF'` and explained unquoted expansion unprompted. Shipped on the maintainer's
      explicit instruction to ship the queue, not on a failing baseline. Recorded honestly.
