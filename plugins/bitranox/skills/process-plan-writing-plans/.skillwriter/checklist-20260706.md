# skill-writer checklist - process-plan-writing-plans (2026-07-06, roster review wave 3)

- [x] Change: description gains the 'implementation plan' keyword; superpowers credit line + THIRD_PARTY_NOTICES entry added (verified upstream roster: obra/superpowers ships the ancestor; MIT notice now travels with the copy)
