...
| `skill_placement`   | `lowest` [default]                 | where a newly created skill lives: the LOWEST scope that fits (a repo's own `.claude/skills/` extension before user scope `~/.claude/skills/`). Proposing a skill to the public marketplace is ALWAYS ask-first, regardless of this knob.                                                                                                                                                                                                       |
