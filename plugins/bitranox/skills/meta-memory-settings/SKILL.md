...
| `forgetting`         | `conservative` [default], `aggressive`, `off` | how readily an unused, non-must-always entry is archived out of the always-present window. off never forgets.                                                                                                                 |
| `forget_idle_dreams` | integer [3]                                   | conservative threshold: archive after this many idle dreams.                                                                                                                                                                  |
