...
Dropping is a JUDGEMENT, so record the evidence in `--reason`: "verified false, <the check you ran>"
or "shipped in <version>". A queue entry you merely doubt is not a drop - test it and find out.
