...
- We've stored the result of `set_interval` which returns a [Timer](https://textual.textualize.io/api/timer/) object. We will use this to _resume_ the timer when we start the Stopwatch.
