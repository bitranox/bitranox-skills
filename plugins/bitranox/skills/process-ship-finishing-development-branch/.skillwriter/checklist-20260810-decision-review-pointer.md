# checklist - point at the decision review from finishing a branch
...
- [x] The line states WHY this moment is the right one to ask - a merge is the last cheap moment, and the diff hides defaults, version tiers and scope cuts - rather than only naming
