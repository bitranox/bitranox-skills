# skill-writer checklist - git-worktrees: ship queued cross-project contributions (2026-07-30)
...
- [x] Evidence, verbatim where quoted: sonnet called the shared CARGO_TARGET_DIR unsound and handled the stale-worktree half unprompted.
      Shipped on the maintainer's instruction. Both rows are concrete mechanics, not judgement calls.
