# checklist - point at the decision review from the end of a quality sweep
...
- [x] The line states WHY this moment is the right one to ask - the fixes just made in the sweep are themselves unreviewed decisions - rather than only naming
