...
meta-self-improve on those candidates - and meta-dream if a consolidation is due - so nothing is
...
def main():
    ...
    if due:
        msg += ", then bitranox:meta-dream to consolidate memory (a consolidation is due)"
    msg += "."
    parts = [msg]
