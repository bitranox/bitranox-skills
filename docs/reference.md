...
| `classifier_skill_router`  | `off`, `shadow`           | `off`          | Shadow-compare the skill router: one yes/no question per shipped skill over the prompt, beside the keyword match.                                                                                                                                                                                                                                                      | Together with `classifier_backend = jev`, to collect a comparison for the router.                                                                                                                                |
